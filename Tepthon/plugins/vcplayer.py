...
from ..vc_tepthon.stream_helper import Stream
from ..vc_tepthon.tg_downloader import tg_dl
from ..vc_tepthon.vcp_helper import ZedVC
...
ZelzalMusic_cmd = (
"[ᯓ تيبثـون - أوامـر الصوتيـات 😀](t.me/Tepthon) ."
"**⋆─┄─┄─┄─┄──┄─┄─┄─┄─⋆**\n"
"⚉ `.شغل`\n"
